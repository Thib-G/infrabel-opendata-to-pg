...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.geotracks;'
ogr2ogr -a_srs EPSG:31370 -f PGDump -nln geotracks -lco "GEOMETRY_NAME=geom" -lco "SCHEMA=infrabel" -lco "CREATE_SCHEMA=OFF" -lco "CREATE_TABLE=OFF" -append /vsistdout/ "geotracks.json" | psql -U pgthib -d opendata -q -f -
...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.kp;'
ogr2ogr -a_srs EPSG:31370 -f PGDump -nln kp -lco "GEOMETRY_NAME=geom" -lco "SCHEMA=infrabel" -lco "CREATE_SCHEMA=OFF" -lco "CREATE_TABLE=OFF" -append /vsistdout/ "kp.json" | psql -U pgthib -d opendata -q -f -
...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.line_sections;'
ogr2ogr -a_srs EPSG:31370 -f PGDump -nln line_sections -lco "GEOMETRY_NAME=geom" -lco "SCHEMA=infrabel" -lco "CREATE_SCHEMA=OFF" -lco "CREATE_TABLE=OFF" -append /vsistdout/ "line_sections.json" | psql -U pgthib -d opendata -q -f -
...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.points_op;'
ogr2ogr -a_srs EPSG:31370 -f PGDump -nln points_op -lco "GEOMETRY_NAME=geom" -lco "SCHEMA=infrabel" -lco "CREATE_SCHEMA=OFF" -lco "CREATE_TABLE=OFF" -append /vsistdout/ "points_op.json" | psql -U pgthib -d opendata -q -f -
...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.track_segments;'
ogr2ogr -a_srs EPSG:31370 -f PGDump -nln track_segments -lco "GEOMETRY_NAME=geom" -lco "SCHEMA=infrabel" -lco "CREATE_SCHEMA=OFF" -lco "CREATE_TABLE=OFF" -append /vsistdout/ "track_segments.json" | psql -U pgthib -d opendata -q -f -
...
psql -U pgthib -d opendata -c 'TRUNCATE infrabel.kp_by_line;' -c "\copy infrabel.kp_by_line (kp_id, line_id) from 'kp_by_line.csv' csv header;"
# Mise à jour des vues matérialisées
psql -U pgthib -d opendata -c 'REFRESH MATERIALIZED VIEW infrabel.kp_by_track_mv;'
